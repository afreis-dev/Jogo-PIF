 ...
 *
 * Entre cada onda, o jogador ve 3 cartas e escolhe uma. Opcionalmente pode
 ...
 *   3. cartas_desenhar_ui() mostra as 3 opcoes
...
/* Preenche ej->escolhas_upgrade com 3 cartas aleatorias. */
void cartas_gerar_escolhas(EstadoJogo *ej);

/* Aplica o efeito da carta escolhida (indice 0, 1 ou 2) no jogador. */
