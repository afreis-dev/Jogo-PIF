 ...
 *
 * Ex.: carta base e "+10 dano". O jogador rola um d6:
 *   1-2 → +5 dano  (pior)
 *   3-4 → +10 dano (igual)
 *   5   → +15 dano + area maior
 *   6   → +20 dano + ignite
 *
 * A struct Dado (definida em tipos.h) tem: faces (tipo de dado) e
 * ultimo_resultado (pra mostrar na animacao de rolar).
 * ========================================================================== */
 ...
 * Tambem guarda em d->ultimo_resultado pra UI mostrar. */
int dado_rolar(Dado *d);

/* Desenha o dado na tela (numero de faces + ultimo resultado). */
